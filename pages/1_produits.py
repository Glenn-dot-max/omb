...
with tab1:
  ...
  if produits:
    ...
    with col2:
      cat_filter = st.selectbox("Filtrer par catégorie", ["Tous"] + [cat['nom'] for cat in categories if cat['nom']], key="filtrer_cat")
...
with tab2:
  ...
  if categories:
    ...
    st.info("Aucune catégorie. Créer-en une ci-dessus !")
...
with tab3:
  ...
  if types:
    ...
    st.info("Aucun type. Créez-en une ci-dessus !")
